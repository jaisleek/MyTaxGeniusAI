...
import marketWomanImg from '../assets/images/nigerian_market_woman_1781095457212.png';
...
export default function BlogPost() {
  ...
  const postContent: Record<string, any> = {
    ...
    "what-is-tin": {
      title: "Wetin be Tax ID and Why You Need Am?",
      image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f",
      tag: "Pidgin Guides",
      duration: "3 min read",
      intro: "A simple, straightforward breakdown of what a Tax Identification Number (Tax ID) is, how to get one, and why it's essential for your business.",
      content: "Tax ID just means Tax Identification Number. It's like your BVN but for tax. Whether you are opening a corporate bank account, applying for a government loan, or importing goods, you cannot escape showing your Tax ID. The best part? Getting it is completely free online through the official JTB portal."
    },
    "market-tax": {
      title: "How Market Women Can Pay Small Small Tax",
      image: marketWomanImg,
      tag: "Small Business",
      duration: "4 min read",
