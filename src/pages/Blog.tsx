...
export default function Blog() {
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen pb-20 mt-16 md:mt-24">

      {/* HERO */}
      <section className="bg-[#0F172A] py-20 px-4 mb-16 rounded-b-[3rem]">
            ...
            {posts.map((post, idx) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {post.isFeatured && (
                    <span className="text-xs bg-emerald-100 text-emerald-700 px-2 py-1 rounded-full inline-block mb-2">
                      Featured
                    </span>
                  )}
