...
import { NigeriaInteractiveMap } from '../components/NigeriaInteractiveMap';
    ...
    <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-emerald-50/50 dark:bg-emerald-900/20 p-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-5 shadow-sm transition-colors duration-300 hover:border-emerald-300 dark:hover:border-emerald-700">
               ...
               <p className="text-sm text-slate-500 dark:text-slate-400">Your Tax ID and corporate details are verified instantaneously against national registries to prevent fraud.</p>
            </div>
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-5 shadow-sm transition-colors duration-300 hover:border-emerald-300 dark:hover:border-emerald-700">
      ...
      <div className="mb-12">
        <div className="mb-6 text-center">
          <h2 className="text-2xl font-black text-gray-900 dark:text-white">State IRS Directory Hub</h2>
          <p className="text-gray-600 dark:text-gray-400 font-medium">Select a regional node to view direct contact details and official portals for State Tax Authorities.</p>
        </div>
        <NigeriaInteractiveMap />
      </div>
          ...
          <Link to="/blog/wetin-be-tin" className="group bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-6 hover:shadow-md hover:border-blue-500 dark:hover:border-blue-600 transition-all duration-300 flex flex-col justify-between h-full">
            <div>
              ...
              <h3 className="font-bold text-gray-900 dark:text-white text-lg leading-snug mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                Wetin be Tax ID and Why You Need Am?
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-3 mb-4">
                If you dey do business or you dey receive salary, government say you must get Tax ID. E easy and e free. See how to get yours.
              </p>
            </div>
            <div className="flex justify-between items-center text-sm font-medium">
