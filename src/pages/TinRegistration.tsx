  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || 'Failed to register Tax ID');
      }
    } catch (err) {
      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 mt-10">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-green-100 text-center">
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8">
            <p className="text-sm text-gray-500 uppercase tracking-wider font-semibold mb-1">Your Tax ID</p>
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Get Your Tax ID</h1>
