...
const Home = () => {
  ...
  return (
    <div className="flex flex-col bg-[#FAFAFA] dark:bg-slate-950 transition-colors duration-300 overflow-hidden -mt-35 lg:-mt-40">
      ...
      <section className="relative overflow-hidden bg-[#0F172A] pt-40 pb-28 md:pt-55 md:pb-40">
        ...
        <motion.div 
          ...
          className="absolute top-[-20%] right-[-10%] w- h-150 bg-linear-to-r from-fuchsia-600 via-purple-600 to-indigo-600 rounded-full blur-[120px] pointer-events-none z-0 mix-blend-screen"
        ></motion.div>
        <motion.div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-linear-to-r from-fuchsia-500/10 to-emerald-500/10 border border-fuchsia-500/20 text-fuchsia-300 font-bold mb-4 shadow-[0_0_20px_rgba(217,70,239,0.15)]">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.1]">
                Tax no <br/>
                <span className="text-transparent bg-clip-text bg-linear-to-r from-fuchsia-400 via-purple-400 to-emerald-400">
                  suppose hard.
                </span>
              </h1>
          ...
          <div className="relative p-10 lg:p-16 flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              ...
              <h2 className="text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.15]">
                Complete Financial Ops & Tax Reconciliation.
              </h2>
              <p className="text-lg text-slate-300 font-medium leading-relaxed">
                Streamline your Accounts Payable and Receivable, send NRS-compliant e-invoices instantly, and automate your tax remittance via our new Rev360 API. Connect with a network of <strong className="text-white">ICAN/CITN certified professionals</strong> directly on your dashboard.
              </p>
              
              <ul className="space-y-4">
                <li className="flex items-center text-slate-200 font-medium text-lg">
                  <CheckCircle className="w-6 h-6 text-fuchsia-400 mr-3 shadow-fuchsia-500/20" /> Auto-calculate 7.5% VAT on B2B Invoices
                </li>
                <li className="flex items-center text-slate-200 font-medium text-lg">
                  <CheckCircle className="w-6 h-6 text-blue-400 mr-3 shadow-blue-500/20" /> Automated Payables & Receivables Sync
                </li>
                <li className="flex items-center text-slate-200 font-medium text-lg">
                  <CheckCircle className="w-6 h-6 text-emerald-400 mr-3 shadow-emerald-500/20" /> Direct Rev360 Payment Gateway Active
                </li>
              </ul>
                ...
                <div className="bg-[#1E293B] border border-white/10 rounded-4xl p-8 relative shadow-2xl backdrop-blur-xl">
                  ...
                  <div className="space-y-5">
                    <div className="flex justify-between items-center text-[15px]">
                      <span className="text-slate-400 font-medium">VAT / Rev360 Sync</span>
                      <span className="font-bold text-emerald-400 text-lg">Synced</span>
                    </div>
                    <div className="flex justify-between items-center text-[15px]">
                      <span className="text-slate-400 font-medium">Accounts Receivable</span>
                      <span className="font-bold text-white text-lg">₦450,000</span>
                    </div>
                    <div className="pt-2">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mb-12">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
                Find the closest NRS or LIRS physical office to you using our intelligent geolocation map. Essential if you need to perform manual audits or physical verification offline.
              </p>
            </div>
          </div>
          <NearestOfficeMap />
