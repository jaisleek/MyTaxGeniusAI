  ...
  const testimonials = [
    {
      ...
      testimony: "Before MyTaxGenius, I used to pay agents ridiculous amounts just to calculate my VAT. The AI correctly identified my exemptions and registered me for my Tax ID in less than a day. Highly trustworthy!",
      rating: 5,
