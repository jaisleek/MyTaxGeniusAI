      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-rose-700 dark:text-rose-400 text-sm md:text-[15px] font-medium leading-relaxed">Beware of fake agents demanding money for "Tax ID Activation". Tax ID registration is strictly free. Always use official portals or authorized gateways like MyTaxGenius.</p>
          </div>
        </motion.div>
